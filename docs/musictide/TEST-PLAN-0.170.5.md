# Test plan — Sveltia fork v0.170.5 (musictide)

Manual `/admin/` verification of the re-derived patch groups **A–F** before the 0.170.5
...
**Build under test:** `/home/n0xx/Code/infra/service/sveltia-cms-mt/wt-0.170.5/package/dist/sveltia-cms.js`
(2.05 MB, branch `musictide-patches-0.170.5`, tip `ac8bd6cc`).
...
cp /home/n0xx/Code/infra/service/sveltia-cms-mt/wt-0.170.5/package/dist/sveltia-cms.js \
...
Only once Phase 1 is clean. Publishing swaps the live CMS to 0.170.5:
...
Fork source is in worktree `sveltia-cms-mt/wt-0.170.5`. Fix there, rebuild
